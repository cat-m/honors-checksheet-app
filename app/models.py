...
class Checksheet(db.Model):
    ...
    initialEssayDate = db.Column(db.String(200))
    coCur1 = db.Column(db.String(200))
    coCurDate1 = db.Column(db.String(200))
    coCur2 = db.Column(db.String(200))
    coCurDate2 = db.Column(db.String(200))
    coCur3 = db.Column(db.String(200))
    coCurDate3 = db.Column(db.String(200))
    coCur4 = db.Column(db.String(200))
    coCurDate4 = db.Column(db.String(200))
    coCur5 = db.Column(db.String(200))
    coCurDate5 = db.Column(db.String(200))
    coCur6 = db.Column(db.String(200))
    coCurDate6 = db.Column(db.String(200))
    coCur7 = db.Column(db.String(200))
    coCurDate7 = db.Column(db.String(200))
    coCur8 = db.Column(db.String(200))
    coCurDate8 = db.Column(db.String(200))
