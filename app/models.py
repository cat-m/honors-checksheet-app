...
class Checksheet(db.Model):
    ...
    initialEssayDate = db.Column(db.Date, nullable=True)
    coCur1 = db.Column(db.String(200))
    coCurDate1 = db.Column(db.Date, nullable=True)
    coCur2 = db.Column(db.String(200))
    coCurDate2 = db.Column(db.Date, nullable=True)
    coCur3 = db.Column(db.String(200))
    coCurDate3 = db.Column(db.Date, nullable=True)
    coCur4 = db.Column(db.String(200))
    coCurDate4 = db.Column(db.Date, nullable=True)
    coCur5 = db.Column(db.String(200))
    coCurDate5 = db.Column(db.Date, nullable=True)
    coCur6 = db.Column(db.String(200))
    coCurDate6 = db.Column(db.Date, nullable=True)
    coCur7 = db.Column(db.String(200))
    coCurDate7 = db.Column(db.Date, nullable=True)
    coCur8 = db.Column(db.String(200))
    coCurDate8 = db.Column(db.Date, nullable=True)
