...
class Checksheet(db.Model):
    ...
    initialEssayDate = db.Column(db.String(60))
    coCur1 = db.Column(db.String(200))
    coCurDate1 = db.Column(db.String(60))
    coCur2 = db.Column(db.String(200))
    coCurDate2 = db.Column(db.String(60))
    coCur3 = db.Column(db.String(200))
    coCurDate3 = db.Column(db.String(60))
    ...
    coCurDate7 = db.Column(db.String(60))
    coCur8 = db.Column(db.String(200))
    coCurDate8 = db.Column(db.String(60))
